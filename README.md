...
This is a frontend (Dapp) for the lottery smart contract.(see below)

[Smart Contract Repo](https://github.com/SaikrishnaReddy1919/hardhat_lottery_app)
...
```
git clone https://github.com/SaikrishnaReddy1919/Nextjs-lottery-frontend.git
cd Nextjs-lottery-frontend
yarn
yarn dev
```
### Optional Gitpod
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://github.com/SaikrishnaReddy1919/Nextjs-lottery-frontend)
...
> You can read more about how to use that repo from its [README.md](https://github.com/SaikrishnaReddy1919/hardhat_lottery_app)
